...
public class TrainingCourseController {
   ...
   * @return
   */
  @RequestMapping(value = "/traningPlan/save", method = RequestMethod.POST)
  ...
  @RequestMapping(value = "/traningPlan/{uuid}", method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/traningPlan/my", method = RequestMethod.GET)
   ...
   * @return
   */
  @RequestMapping(value = "/traningPlan/queryPublish", method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/traningPlan/my/{ids}", method = RequestMethod.DELETE)
